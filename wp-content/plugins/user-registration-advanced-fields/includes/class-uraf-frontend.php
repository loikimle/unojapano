	...
	public function user_registration_form_field_render( $field, $key, $args, $value ) {
		...
		switch ( $args['type'] ) {
			...
			case 'range':
			    ...
			    if ( "true" === $args['enable_payment_slider']) {
	...
	public function user_registration_form_field_profile_picture( $field, $key, $args, $value ) {
		...
		<div class="uraf-profile-picture-upload">
			<p class="form-row " id="<?php echo $key; ?>_field" data-priority="">
				...
				$valid_file_type = isset($valid_file_type)  ? implode( ', ', $valid_file_type ) : 'image/jpeg,image/jpg,image/gif,image/png';
				...
				<input type="file" id="ur-profile-pic" name="profile-pic" class="profile-pic-upload" size="<?php echo $max_upload_size; ?>" accept="<?php echo $valid_file_type ?>" />
