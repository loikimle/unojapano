	...
	<form method="<?php echo esc_attr( apply_filters( 'user_registration_content_restriction_settings_form_method_tab_' . $current_tab, 'post' ) ); ?>" id="mainform" action="" enctype="multipart/form-data">
		...
		<p class="submit">
			<?php if ( ! isset( $GLOBALS['hide_save_button'] ) ) : ?>
				<input name="save" class="button-primary" type="submit" value="<?php echo apply_filters('user-registration-content-restriction-setting-save-label', esc_attr('Save Changes', 'user-registration-content-restriction' )); ?>" />
			<?php endif; ?>
