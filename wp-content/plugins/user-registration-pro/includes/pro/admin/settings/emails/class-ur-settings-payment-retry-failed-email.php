	...
	class UR_Settings_Payment_Retry_Failed_Email {
						...
						'payment_retry_failed_email' => array(
							...
							'settings'     => array(
								...
								array(
									...
									'type'     => 'text',
									'default'  => __( 'Payment Attempt Unsuccessful', 'user-registration' ),
									'css'      => '',
									'desc_tip' => true,
								),
								array(
		...
		public static function ur_get_payment_retry_failed_email() {
			...
			$message = apply_filters(
				'user_registration_payment_retry_failed_email_message',
				sprintf(
					__('Hi, {{username}}<br>
We were unable to process your recent payment due to a temporary issue.<br>
No action is required from you at this time. We will attempt to process the payment again and will contact you only if further action is required.<br> 
{{payment_invoice}}<br>
