...
<div class="ldgr-group-code-container">
    ...
    <form method="post" id="ldgr-group-code-create-form" class="ldgr-form">
        <p>
            ...
            <input type="button" class="ldgr-generate-group-code" value="<?php esc_html_e( 'Generate', WDM_LDGR_TXT_DOMAIN ); ?>">
        ...
        <p>
            <input type="submit" value="<?php esc_html_e( 'Submit', WDM_LDGR_TXT_DOMAIN ); ?>">
        </p>
    </form>
</div>