 ...
 function jannah_plugins_installer_data( $plugins_data = false ){
	...
	return array(
		'taqyeem' => array(
			'name'   => 'Taqyeem',
			'slug'   => 'taqyeem',
			'source' => get_template_directory() . '/plugins/taqyeem.zip',
		),
		'jannah-extensions' => array(
			'name'   => 'Taqyeem Buttons',
			'slug'   => 'taqyeem-buttons',
			'source' => get_template_directory() . '/plugins/taqyeem-buttons.zip',
		),
		'jannah-extensions' => array(
			'name'   => 'Taqyeem Predefined',
			'slug'   => 'taqyeem-predefined',
			'source' => get_template_directory() . '/plugins/taqyeem-predefined.zip',
		),
		'jannah-extensions' => array(
			'name'   => 'Wp Tiktok Feed',
			'slug'   => 'wp-tiktok-feed',
			'source' => get_template_directory() . '/plugins/wp-tiktok-feed.zip',
		),
		'jannah-extensions' => array(
			'name'   => 'Jannah Extensions',
			'slug'   => 'jannah-extensions',
			'source' => get_template_directory() . '/plugins/jannah-extensions.zip',
		),
		'arqam-lite' => array(
			'name'   => 'Arqam Lite',
			'slug'   => 'arqam-lite',
			'source' => get_template_directory() . '/plugins/arqam-lite.zip',
		),
		'jannah-switcher' => array(
			'name'   => 'Jannah Switcher',
			'slug'   => 'jannah-switcher',
			'source' => get_template_directory() . '/plugins/jannah-switcher.zip',
		),
		'jannah-optimization' => array(
			'name'   => 'Jannah Speed Optimization',
			'slug'   => 'jannah-optimization',
			'source' => get_template_directory() . '/plugins/jannah-optimization.zip',
		),
		'tielabs-instagram' => array(
			'name'   => 'TieLabs Instagram Feed',
			'slug'   => 'tielabs-instagram',
			'source' => get_template_directory() . '/plugins/tielabs-instagram.zip',
		),
		'jannah-autoload-posts' => array(
			'name'   => 'Jannah Autoload Posts',
			'slug'   => 'jannah-autoload-posts',
			'source' => get_template_directory() . '/plugins/jannah-autoload-posts.zip',
		),
	);
